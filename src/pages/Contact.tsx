...
/**
 * CONTACT
 * - Pure React + styled-components (no backend needed)
 * - The form uses a "mailto:" link. Swap to Formspree/EmailJS later if you want server delivery.
 */
...
const CONTACT = {
  ...
  linkedin: "https://www.linkedin.com", // TODO: update to your real profile
};
    ...
    <Section id="contact">
      <Container>
        <Left>
          ...
          <Subtitle>
            I'm open to internships and part-time roles. For the fastest
            response, email me.
          </Subtitle>
            ...
            <InfoItem>
              ...
              <div>
                ...
                <Value>
                  ...
                  <CopyBtn onClick={() => handleCopy(CONTACT.email, "email")}>
            ...
            <InfoItem>
              ...
              <div>
                ...
                <Value>
                  ...
                  <CopyBtn onClick={() => handleCopy(CONTACT.phone, "phone")}>
        ...
        <Right>
          <Card>
            <Form onSubmit={onSubmit} noValidate>
              ...
              <Submit disabled={!isValid} aria-disabled={!isValid}>
                Send email
              </Submit>

              <Hint>
                No backend needed — this opens your mail app with the message
                pre-filled.
              </Hint>
            </Form>
          </Card>
...
const Section = styled.section`
  width: 100%;
  padding: 88px 0;
  background: radial-gradient(80% 120% at 10% -10%, #f1f3f5 0, transparent 60%),
