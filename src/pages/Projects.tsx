...
const PROJECTS: Project[] = [
  {
    ...
    linkGit: "https://github.com/DatLe328/CourseAppIT01",               // add your repo later if public
    member: "3",
  ...
  },
  {
    ...
    linkLive: "",
    linkGit: "",               // add your repo later if public
    member: "2",
    role: "Full-stack with focus on backend and database design; built admin UI.",
    result:
      "Improved database design and Flask API development; implemented basic real-time endpoints and admin workflows.",
  },
];
